...
<template>
    <dl v-if="frontmatter.author" class="pt-6 pb-10 xl:pt-11 xl:border-b xl:border-gray-200 dark:xl:border-slate-200/5">
                    ...
                    <dl class="text-sm font-medium leading-5 whitespace-nowrap">
                        ...
                        <dd v-if="frontmatter.twitter">
                            <a :href="'https://twitter.com/' + frontmatter.twitter" target="_blank"
                                rel="noopnener noreferrer" class="link">{{ frontmatter.twitter }}</a>
                        </dd>
                    </dl>
                </li>
            </ul>
